...
UserManager tiene la responsabilidad de Registrar a un usuario y la de enviar un mensaje de saludo al realizar el registro.

- Que ocurre si cambia la forma de guardar datos?

Si cambia la forma en que se guardan los datos, por ejemplo, a usuario se le pide un dato mas, se tendria que modificar en varias partes del codigo, en la interfaz, en la clase, etc.

- Que clase podria encargarse de enviar correos?

Una clase de SendEmail que solamente se encargue de enviar el mensaje de saludo.
